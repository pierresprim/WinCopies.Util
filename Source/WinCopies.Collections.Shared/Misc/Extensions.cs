...
namespace WinCopies.Collections
{
    public static class Extensions
    {
        ...
        public static
            ...
            ILinkedListNode
#endif
            <T>[] AddRangeFirst<T>(this ILinkedList<T> collection, in IEnumerable<T> array)
        {
            ThrowIfNull(collection, nameof(collection));
        ...
        public static
            ...
            ILinkedListNode
#endif
            <T>[] AddRangeLast<T>(this ILinkedList<T> collection, params T[] values) => collection.AddRangeLast((IEnumerable<T>)values);
        ...
        public static
            ...
            ILinkedListNode
#endif
            <T>[] AddRangeLast<T>(this ILinkedList<T> collection, in IEnumerable<T> array)
        {
            ThrowIfNull(collection, nameof(collection));
            ThrowIfNull(array, nameof(array));
        ...
        public static
            ...
            ILinkedListNode
#endif
            <T> node, params T[] values) => collection.AddRangeBefore(node, (IEnumerable<T>)values);
