...
namespace WinCopies.Collections.DotNetFix
{
    ...
    [Serializable]
    public class QueueCollection<T> : IEnumerableQueue<T>, IReadOnlyCollection<T>, ICollection
    {
        protected internal
#if !WinCopies3
...
int
        ...
        /// </summary>
        /// <param name="item">The object to add to the <see cref="QueueCollection{T}"/>. The value can be <see langword="null"/> for reference types.</param>
        public void Enqueue(T item) => EnqueueItem(item);
        ...
        public bool TryDequeue(
                ...
                [MaybeNullWhen(false)]
#endif
                out T result) => TryDequeueItem(out result);
