...
{
    public interface IReadOnlyDictionary<TKey, TValue> : System.Collections.Generic.IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IReadOnlyUIntCollection<KeyValuePair<TKey, TValue>>
    {
    ...
    public class ReadOnlyLinkedDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>
    {
        public abstract class DictionaryItemCollectionBase<T> : IReadOnlyUIntCollection<T>
        {
        ...
        public ReadOnlyLinkedDictionary(in ILinkedList<KeyValuePair<TKey, TValue>> list)
        {
            InnerList = list;
        }

        public ReadOnlyLinkedDictionary() : this(new LinkedList<KeyValuePair<TKey, TValue>>()) { /* Left empty. */ }
    ...
    public class LinkedDictionary<TKey, TValue> : ReadOnlyLinkedDictionary<TKey, TValue>, IDictionary<TKey, TValue>
    {
        ...
        public new TValue this[TKey key]
        {
            ...
            set
            {
                (Find(key) ?? throw GetKeyNotFoundException(nameof(key))).Value = new KeyValuePair<TKey, TValue>(key, value);
            }
        }

        public LinkedDictionary(in ILinkedList<KeyValuePair<TKey, TValue>> list) : base(list) { /* Left empty. */ }

        protected void Add(KeyValuePair<TKey, TValue> item, in string exceptionMessage, in string paramName) => InnerList.Add(Keys.Contains(item.Key) ? throw new ArgumentException(exceptionMessage, paramName) : item);
