...
#if WinCopies3
        AlwaysConvertibleOneWayConverter<Bitmap, object, ImageSource>
    {
        ...
        /// <returns></returns>
        protected override Bitmap ConvertBack(ImageSource value, object parameter, CultureInfo culture) => null;
#else
        ConverterBase
    {
