...
#endif
{
    ...
    {
        #region Array Throws
        public static ArgumentException GetArrayWithMoreThanOneDimensionException(string paramName) => new ArgumentException(ArrayWithMoreThanOneDimension, paramName);

        public static void ThrowArrayWithMoreThanOneDimensionException(string paramName) => throw GetArrayWithMoreThanOneDimensionException(paramName);
        ...
        public static void ThrowMultidimensionalArraysNotSupportedException(in string arrayArgumentName) => throw GetMultidimensionalArraysNotSupportedException(arrayArgumentName);
        ...
        public static void ThrowArrayHasNonZeroLowerBoundException(in string arrayArgumentName) => throw GetArrayHasNonZeroLowerBoundException(arrayArgumentName);
        ...
        public static void ThrowArrayHasNotEnoughSpaceException(in string arrayArgumentName) => throw GetArrayHasNotEnoughSpaceException(arrayArgumentName);
        ...
        public static void ThrowOnInvalidCopyToArrayOperation(in Array array, in int arrayIndex, in int count, in string arrayArgumentName, in string arrayIndexArgumentName)
        {
            ...
            if (array.Rank != 1)
                ...
                ThrowMultidimensionalArraysNotSupportedException(arrayArgumentName);

            if (array.GetLowerBound(0) != 0)

                ThrowArrayHasNonZeroLowerBoundException(arrayArgumentName);
            ...
            if (array.Length - arrayIndex < count)
                ...
                ThrowArrayHasNotEnoughSpaceException(arrayArgumentName);
        }
#endif
        ...
        public static InvalidOperationException GetDeclaringTypesNotCorrespondException(string propertyName, string methodName) => new InvalidOperationException(string.Format(Culture, DeclaringTypesNotCorrespond, propertyName, methodName));
        ...
        public static ArgumentException GetFieldOrPropertyNotFoundException(string fieldOrPropertyName, Type objectType) => new ArgumentException(string.Format(CultureInfo.CurrentCulture, FieldOrPropertyNotFound, fieldOrPropertyName, objectType));
        ...
        public static ArgumentException GetOneOrMoreKeyIsNull() => new ArgumentException(OneOrMoreKeyIsNull);

        public static void ThrowOneOrMoreKeyIsNull() => throw GetOneOrMoreKeyIsNull();
