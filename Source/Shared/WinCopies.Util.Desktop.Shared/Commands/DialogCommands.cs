...
Commands
{
    public static class DialogCommands
    {
        ...
        public static RoutedUICommand YesToAll { get; } = new RoutedUICommand(
#if !WinCopies3
            WinCopies.Util.
#endif
