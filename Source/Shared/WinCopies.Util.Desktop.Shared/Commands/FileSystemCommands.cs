...
Commands
{
    ...
    public static class FileSystemCommands
    {
        ...
        /// </summary>
        public static RoutedUICommand NewFolder { get; } = new RoutedUICommand(
#if !WinCopies3
            WinCopies.Util.
#endif
        ...
        /// </summary>
        public static RoutedUICommand NewArchive { get; } = new RoutedUICommand(
#if !WinCopies3
            WinCopies.Util.
#endif
        ...
        /// </summary>
        public static RoutedUICommand FileProperties { get; } = new RoutedUICommand(
#if !WinCopies3
            WinCopies.Util.
#endif
