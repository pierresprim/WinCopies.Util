...
namespace WinCopies.Collections.DotNetFix.Generic
{
    public class LinkedDictionary<TKey, TValue> : ReadOnlyLinkedDictionary<TKey, TValue>, ILinkedDictionary<TKey, TValue>
    {
        ...
        public new ILinkedListNodeBase<KeyValuePair<TKey, TValue>> First => InnerList.First.ToReadOnly2();

        public new ILinkedListNodeBase<KeyValuePair<TKey, TValue>> Last => InnerList.Last.ToReadOnly2();
        ...
        protected virtual void OnAdding(KeyValuePair<TKey, TValue> item) => InnerList.Add(item);
