...
namespace WinCopies.Collections.DotNetFix.Generic
{
    public partial class ReadOnlyLinkedDictionary<TKey, TValue> : IReadOnlyLinkedDictionary<TKey, TValue>
    {
        ...
        protected System.Collections.Generic.ICollection<KeyValuePair<TKey, TValue>> InnerCollection => InnerList;
        ...
        public bool Contains(KeyValuePair<TKey, TValue> item) => InnerCollection.Contains(item);
        ...
        public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex) => InnerCollection.CopyTo(array, arrayIndex);
        ...
        public IUIntCountableEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() => InnerList.AsFromType<Enumeration.IEnumerable<IUIntCountableEnumerator<KeyValuePair<TKey, TValue>>>>().GetEnumerator();
