...
- New static methods.
- Update shift operations.
- Bug fix in the InvalidEnumArgumentException(string message, string argumentName, Enum invalidValue) constructor -- an exception was thrown for some values.
