...
namespace WinCopies.Tests.Util.Util
{
    ...
    public class Math
    {
        private void AssertAdditionResultInRange(ulong left, ulong right, ulong maxValue, bool shouldSucceed, ulong expectedResult, NumericTypes numericTypes)
        {
            ...
            {
                result = WinCopies.Util.Math.IsAdditionResultInRange(left, right, maxValue);
                ulong? resultULong = WinCopies.Util.Math.TryAdd(left, right, maxValue);
            ...
            if (numericTypes.HasFlag(NumericTypes.UInt))
            {
                ...
                result = WinCopies.Util.Math.IsAdditionResultInRange(_left, _right, _maxValue);
                uint? resultUInt = WinCopies.Util.Math.TryAdd(_left, _right, _maxValue);
            ...
            if (numericTypes.HasFlag(NumericTypes.UShort))
            {
                ...
                result = WinCopies.Util.Math.IsAdditionResultInRange(_left, _right, _maxValue);
                ushort? resultUShort = WinCopies.Util.Math.TryAdd(_left, _right, _maxValue);
            ...
            if (numericTypes.HasFlag(NumericTypes.Byte))
            {
                ...
                result = WinCopies.Util.Math.IsAdditionResultInRange(_left, _right, _maxValue);
                byte? resultByte = WinCopies.Util.Math.TryAdd(_left, _right, _maxValue);
        ...
        private void AssertMultiplicationResultInRange(ulong left, ulong right, ulong maxValue, bool shouldSucceed, ulong expectedResult, NumericTypes numericTypes)
        {
            ...
            if (numericTypes.HasFlag(NumericTypes.ULong))
            {
                result = WinCopies.Util.Math.IsMultiplicationResultInRange(left, right, maxValue);
                ulong? resultULong = WinCopies.Util.Math.TryMultiply(left, right, maxValue);
            ...
            if (numericTypes.HasFlag(NumericTypes.UInt))
            {
                ...
                result = WinCopies.Util.Math.IsMultiplicationResultInRange(_left, _right, _maxValue);
                uint? resultUInt = WinCopies.Util.Math.TryMultiply(_left, _right, _maxValue);
            ...
            if (numericTypes.HasFlag(NumericTypes.UShort))
            {
                ...
                result = WinCopies.Util.Math.IsMultiplicationResultInRange(_left, _right, _maxValue);
                ushort? resultUShort = WinCopies.Util.Math.TryMultiply(_left, _right, _maxValue);
            ...
            if (numericTypes.HasFlag(NumericTypes.Byte))
            {
                ...
                result = WinCopies.Util.Math.IsMultiplicationResultInRange(_left, _right, _maxValue);
                byte? resultByte = WinCopies.Util.Math.TryMultiply(_left, _right, _maxValue);
